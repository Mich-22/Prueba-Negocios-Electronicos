...
<div class="row-fluid">
    <!-- Middle Section -->
    <div class="col-sm-offset-3 col-md-4"><br><br><br><br>
        <div id="loadingAlert"
             class="card"
             style="display: none;">
            <div class="card-body">
        ...
        <form id="orderConfirm"
              ...
              style="display: none;">
            <h1>Your payment is authorized.</h1>
            <h1>Confirm the order to execute</h1>
            <hr>
        ...
        <form id="orderView"
            ...
            <hr>
            <h1> Click <a href='../index.php'>here </a> to return to Home Page</h1>
        </form>
    </div>
</div>
