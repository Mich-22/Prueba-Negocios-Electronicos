  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main" style="height: calc(100vh - 60px);">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="../pages/insert-products.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <!--<i class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"></i>-->
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link" href="../pages/estadisticas.php">
            ...
            <span class="nav-link-text ms-1">Estádisticas</span>
          </a>
        </li>
        ...
        <div class="col-lg-12 mb-lg-0 mb-6">
          <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
              <h6 class="text-capitalize">Categorias</h6>
            </div>
...
<?php 
            ...
            {
?>
              <div style="background-color:#d1e7dd; width: 80%; margin-left: 20px; border-radius: 20px;" class="alert alert-dismissible fade show">
                <p style="color: #0f5132; font-size: 16px; margin-left: 20px; ">Categoria creada</p>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" style="color:black; margin-top:-8px;">X</button>
              </div>
...
<?php 
            ...
            {
?>
              <div style="background-color:#f8d7da; width: 80%; margin-left: 20px; border-radius: 20px;" class="alert alert-dismissible fade show">
                <p style="color: #842029; font-size: 16px; margin-left: 20px; ">Categoria eliminada</p>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" style="color:black; margin-top:-8px;">X</button>
              </div>
<?php
           } 
...
<form class="form-horizontal row-fluid" name="Category" method="post" >
            ...
            <div class="card-body p-3">
              <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label" style="font-size:15px;">Nombre</label>
                <input class="form-control" id="exampleFormControlInput1" type="text" name="category" class="span8 tip" required>
              </div>
              
              <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label" style="font-size:15px;">Descripción</label>
                <textarea class="form-control" id="exampleFormControlTextarea1" class="span8" name="description" rows="5"></textarea>
              </div>
              <button type="submit" name="submit"  class="btn btn-outline-primary">Crear</button>
            </div>
          </div>
        </div>
          ...
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h5 class="mb-2">Administrar categorias</h5>
              </div>
<br>
              <label class="form-label" style="font-size:15px; float: left; margin-right: 10px;">Mostrar por</label>
              <select class="form-select" aria-label="Default select example" style="width:8%;  height:40px; margin-top: -8px; float: left; margin-right: 10px; ">
                <option selected>10</option>
                <option value="1">30</option>
                <option value="2">50</option>
                <option value="3">100</option>
              </select>
              <label class="form-label" style="font-size:15px;">entradas</label> 
            </div>
<br>
...
?>                  
                    <tr>
                      <td><p style="margin-left:15px;"><?php echo htmlentities($cnt);?></p></td>
                      <td><?php echo htmlentities($row['categoryName']);?></td>
                      <td><?php echo htmlentities($row['categoryDescription']);?></td>
                      <td><?php echo htmlentities($row['creationDate']);?></td>
                      <td><?php echo htmlentities($row['updationDate']);?></td>
                      <td>
                      <a href="edit-category.php?id=<?php echo $row['id']?>" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
</a>
                      <a style="margin-left:20px;" href="category.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash-o" aria-hidden="true"></i>
</a></td>
                    </tr>
<?php 
                    $cnt=$cnt+1; 
