          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Efectivo del día de hoy</p>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Usuarios nuevos hoy</p>
                    <h5 class="font-weight-bolder">
                      2,300
                    </h5>
                    <p class="mb-0">
                  ...
                  <tr>
                    <td class="w-30">
                      <div class="d-flex px-2 py-1 align-items-center">
                        ...
                        <div class="ms-4">
                          ...
                          <h6 class="text-sm mb-0">Estados Unidos</h6>
                        </div>
                      </div>
                    </td>
                    <td>
                    ...
                    <td class="align-middle text-sm">
                      <div class="col text-center">
                        <p class="text-xs font-weight-bold mb-0">Rebote:</p>
                  ...
                  <tr>
                    <td class="w-30">
                      <div class="d-flex px-2 py-1 align-items-center">
                        ...
                        <div class="ms-4">
                          <p class="text-xs font-weight-bold mb-0">País:</p>
                          <h6 class="text-sm mb-0">Alemania</h6>
                        </div>
                      </div>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td class="w-30">
                      <div class="d-flex px-2 py-1 align-items-center">
                        ...
                        <div class="ms-4">
                          <p class="text-xs font-weight-bold mb-0">País:</p>
                          <h6 class="text-sm mb-0">Gran Bretaña</h6>
                        </div>
                      </div>
                    </td>
                    <td>
            ...
            <div class="card-body p-3">
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  ...
                  -->
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm">Boda</h6>
                      <span class="text-xs">250 en stock, <span class="font-weight-bold">346+ vendidos</span></span>
                    </div>
                  </div>
                  <!--
                  <div class="d-flex">
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  ...
                  -->
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm">Bautizo</h6>
                      <span class="text-xs">123 cerrado, <span class="font-weight-bold">15 abiertos</span></span>
                    </div>
                  </div>
                  <!--
                  <div class="d-flex">
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm">Boda</h6>
                      <span class="text-xs">1 abiertas, <span class="font-weight-bold">40 cerradas</span></span>
                    </div>
                  </div>
                  <!--
                  <div class="d-flex">
