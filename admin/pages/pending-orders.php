...
<head>
  ...
  <title>
    Pedidos pendientes / Azul Society
  </title>
  <!--     Fonts and icons     -->
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main" style="height: calc(100vh - 60px);">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../pages/pending-orders.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <!--<i class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"></i>-->
            </div>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Pedidos pendientes</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Pedidos pendientes</h6>
        </nav>
          ...
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h5 class="mb-2">Pedidos pendientes</h5>
              </div>
<br>
...
<td><?php echo htmlentities($row['shippingaddress'].",".$row['shippingpincode']);?></td>
                      ...
                      <td><p style="margin-left: 45px;"><?php echo htmlentities($row['quantity']);?></p></td>
                      <td><p style="margin-left: 15px;"><?php echo htmlentities($row['quantity']*$row['productprice']+$row['shippingcharge']);?></p></td>
                      <td><?php echo htmlentities($row['orderdate']);?></td>
                      <td> <a href="updateorder.php?oid=<?php echo $row['id']?>" style="margin-left: 25px;" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></td>
