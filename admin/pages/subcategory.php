  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main" style="height: calc(100vh - 60px);">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../pages/subcategory.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <!--<i class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"></i>-->
            </div>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Sub categorias</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Sub categorias</h6>
        </nav>
        ...
        <div class="col-lg-12 mb-lg-0 mb-6">
          <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
              <h6 class="text-capitalize">Sub categorias</h6>
            </div>
...
{?>
                ...
                <p style="color: #0f5132; font-size: 16px; margin-left: 20px; ">Subcategoria creada</p>
...
{?>
                ...
                <p style="color: #842029; font-size: 16px; margin-left: 20px; ">Subcategoria eliminada</p>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" style="color:black; margin-top:-8px;">X</button>
              </div>
<?php } ?>
...
<form class="form-horizontal row-fluid" name="subcategory" method="post" >
            ...
            <div class="card-body p-3">
              <div class="mb-3">
                ...
                <select class="form-select" aria-label="Default select example" style="height:40px;" name="category">
...
?>
              ...
              <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label" style="font-size:15px;">Nombre de la subcategoria</label>
                <input class="form-control" id="exampleFormControlInput1" type="text" name="subcategory" class="span8 tip" required>
              </div>
